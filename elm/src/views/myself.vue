    ...
    <div class="detail_my">
      ...
      <div class="my_list">
        <ul class="my_list_msgs">
          ...
          <router-link to>
            <li><i class="iconfont icon-shangcheng"></i>积分商城&gt;</li>
          </router-link>
          <router-link to>
            <li><i class="iconfont icon-huangguan"></i>饿了么会员卡&gt;</li>
          </router-link>
        </ul>

        <ul class="public_serve">
          <router-link to>
            <li class="my_serve"><i class="iconfont icon-fwzx"></i>服务中心&gt;</li>
          </router-link>
          <router-link to>
            <li class="my_app"><i class="iconfont icon-elem"></i>下载饿了么app&gt;</li>
          </router-link>
        </ul>
      </div>
    </div>
